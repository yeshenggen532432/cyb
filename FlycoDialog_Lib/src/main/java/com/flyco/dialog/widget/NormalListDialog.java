...
public class NormalListDialog extends BaseDialog<NormalListDialog> {
    ...
    private int mTitleBgColor = Color.parseColor("#ff2597f0");//TODO:我改的
    /** title text(标题) */
    private String mTitle = "提示";
    /** title textcolor(标题颜色) */
    private int mTitleTextColor = Color.parseColor("#ffffff");//TODO:我改的
    /** title textsize(标题字体大小,单位sp) */
    private float mTitleTextSize = 18f;
    /** ListView background color(ListView背景色) */
    private int mLvBgColor = Color.parseColor("#ffffff");//TODO:我改的
    ...
    private int mItemPressColor = Color.parseColor("#ffcccccc");//TODO:我改的
    /** item textcolor(ListView item文字颜色) */
    private int mItemTextColor = Color.parseColor("#666666");//TODO:我改的
    ...
    class ListDialogAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            int left = item.mResId == 0 ? dp2px(16) : dp2px(16);//TODO 我改的
...
//            ivItem.setVisibility(item.mResId == 0 ? View.GONE : View.VISIBLE);
            ivItem.setVisibility(item.mResId == 0 ? View.GONE : View.GONE);//TODO 我改的
