...
public class CacheLocationBean extends LitePalSupport {
	private String company_id ;//公司id
	private String user_id ;//用户id
	private double longitude ;
	private double latitude ;
	private long location_time ;//定位时间戳
	private String address;
	private String location_from ;//gps;wifi;lx
	private String os ;//手机型号，版本号
