...
import com.qwb.view.delivery.parsent.PDelivery5;
 ...
 * 创建描述：物流配送-配送终止
 */
public class Delivery5Fragment extends XFragment<PDelivery5> {
	@Override
	...
	@Override
	public PDelivery5 newP() {
		return new PDelivery5();
	}

	public Delivery5Fragment() {
	}
	...
	private String psState = "5";//0:待分配1:待接收2:已接收3:配送中4:已送达5:配送终止
