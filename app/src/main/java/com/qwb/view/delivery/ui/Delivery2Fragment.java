...
import com.qwb.view.delivery.parsent.PDelivery2;
 ...
 * 创建描述：物流配送-待接收
 */
public class Delivery2Fragment extends XFragment<PDelivery2> {
	...
	@Override
	public PDelivery2 newP() {
		return new PDelivery2();
	}
	...
	private String psState = "2";//0:待分配1:待接收2:已接收3:配送中4:已送达5:配送终止
