...
import com.qwb.view.delivery.parsent.PDelivery4;
 ...
 * 修改时间：
 */
public class Delivery4Fragment extends XFragment<PDelivery4> {
	...
	@Override
	public PDelivery4 newP() {
		return new PDelivery4();
	}

	public Delivery4Fragment() {
	}
	...
	private String psState = "4";//0:待分配1:待接收2:已接收3:配送中4:已送达5:配送终止
