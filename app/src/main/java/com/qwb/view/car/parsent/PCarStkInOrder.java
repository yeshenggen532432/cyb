 ...
 * 车销回库单
 */
public class PCarStkInOrder extends XPresent<CarStkInOrderActivity>{
    /**
     * 提交数据或修改数据
     */
    public void addData(Activity activity,String orderId, String stkId,String stkName,String stkInId,String stkInName,String remarks,String totalAmt,String jsonStr,int billType, String queryToken) {
        ...
        if (MyStringUtil.isNotEmpty(queryToken)) {
