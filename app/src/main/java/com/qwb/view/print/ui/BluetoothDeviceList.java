...
import com.qwb.view.print.util.Utils;
...
public class BluetoothDeviceList extends Activity {
 ...
 //   private ArrayAdapter<String> mNewDevicesArrayAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.x_dialog_bluetooth_list);
    ...
    protected void getDeviceList() {
        ...
        DevicesArrayAdapter = new ArrayAdapter<>(this,
                R.layout.x_bluetooth_device_name_item);
...
//        // Get the local Bluetooth adapter
//        mBluetoothAdapter = MyBluetoothAdapter.getDefaultAdapter();
    ...
    private void discoveryDevice() {
       ...
       // lvNewDevice.setVisibility(View.VISIBLE);
        ...
        // Request discover from MyBluetoothAdapter
