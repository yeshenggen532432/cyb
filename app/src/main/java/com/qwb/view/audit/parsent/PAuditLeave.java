...
public class PAuditLeave extends XPresent<AuditLeaveActivity> {
     ...
     */
    public void addData(Activity activity, String title, String type,String dsc, String auditData,String mids, String checkNm,String startTime, String endTime, ArrayList<FileBean> fileList) {
    ...
    private void parseJson1(String response) {
        try {
            ...
            if (object != null) {
                ...
                if (state) {
                    AddCurrentIds.getI().saveToDB(AddCurrentIds.TYPE_QJ);
