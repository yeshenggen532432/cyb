...
import com.qwb.view.audit.model.AuditModelListResult;
import com.qwb.view.audit.model.ShenpiModel;
import com.qwb.view.audit.model.ShenpiModelBean;
import com.qwb.view.audit.ui.AuditTabSendAuditFragment;
 ...
 *  发起审批
 */
public class PAuditTabSendAudit extends XPresent<AuditTabSendAuditFragment>{
     ...
     * 查询审批模板
     */
    public void queryAuditModelList(Activity activity){
        this.context = activity;
        OkHttpUtils
                .post()
                .url(Constans.queryAuditModelList)
                ...
                .execute(new MyHttpCallback(activity) {
                    ...
                    public void myOnResponse(String response, int id) {
                        try {
                            AuditModelListResult bean = JSON.parseObject(response, AuditModelListResult.class);
                            if (null != bean && bean.isState()) {
                                List<AuditModelBean> list = bean.getList();
