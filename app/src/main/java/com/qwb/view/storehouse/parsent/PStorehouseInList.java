...
import com.qwb.view.storehouse.model.StorehouseInListResult;
 ...
 * 库位：入仓单列表
 */
public class PStorehouseInList extends XPresent<StorehouseInListActivity> {
    ...
    public void queryData(Activity activity, String  searchStr, int pageNo, String startDate, String endDate, String status) {
        ...
        OkHttpUtils
                .post()
                .params(params)
                .url(Constans.queryStkCrewInPage)
                .id(1)
                .build()
    ...
    public void updateStatus(Activity activity, Integer billId) {
        ...
        OkHttpUtils
                .post()
                .params(params)
                .url(Constans.updateStatusAuditStkCrewIn)
                .id(1)
                .build()
                .execute(new MyHttpCallback(activity) {
                    @Override
    ...
    private void parseJson1(String response) {
        try {
            StorehouseInListResult bean = JSON.parseObject(response, StorehouseInListResult.class);
            if (bean != null) {
                if (bean.isState()) {
