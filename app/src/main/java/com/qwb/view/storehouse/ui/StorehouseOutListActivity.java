...
import com.qwb.view.storehouse.adapter.StorehouseOutListAdapter;
import com.qwb.view.storehouse.model.StorehouseOutBean;
import com.qwb.view.storehouse.parsent.PStorehouseOutList;
 ...
 * 库位：入仓单列表
 */
public class StorehouseOutListActivity extends XActivity<PStorehouseOutList> {


    public StorehouseOutListActivity() {
    }
    ...
    @Override
    public PStorehouseOutList newP() {
        return new PStorehouseOutList();
    }
    ...
    StorehouseOutListAdapter mAdapter;
    private int pageNo = 1;
    @BindView(R.id.refreshLayout)
    RefreshLayout mRefreshLayout;
    private StorehouseOutBean mCurrentItem;
    ...
    private void initAdapter() {
        ...
        mRecyclerView.addItemDecoration(new HorizontalDividerItemDecoration.Builder(context)
                ...
                .build());
        mAdapter = new StorehouseOutListAdapter();
        mRecyclerView.setAdapter(mAdapter);
        mAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(BaseQuickAdapter baseQuickAdapter, View view, int i) {
                try {
                    StorehouseOutBean item = (StorehouseOutBean)baseQuickAdapter.getData().get(i);
                    ActivityManager.getInstance().jumpToStorehouseOutActivity(context, item.getId(), TypeEnum.DETAIL);
                }catch (Exception e){
        ...
        mAdapter.setOnItemChildClickListener(new BaseQuickAdapter.OnItemChildClickListener() {
            ...
            public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
                try {
                    StorehouseOutBean item = (StorehouseOutBean)adapter.getData().get(position);
                    mCurrentItem = item;
     ...
     * 刷新适配器
     */
    public void refreshAdapter(List<StorehouseOutBean> dataList) {
