...
import com.qwb.view.customer.ui.MineClientFragment;
 ...
 * 修改时间：
 */
public class PMineClient extends XPresent<MineClientFragment>{
    ...
    private void parseJson1(String response) {
        try {
            ...
            if (parseObject != null && parseObject.isState()) {
                ...
                getV().refreshAdapter(dataList,parseObject.getTotal(),true);//列表数量，我的客户数量
            } else {
