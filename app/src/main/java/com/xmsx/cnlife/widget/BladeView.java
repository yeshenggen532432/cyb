...
public class BladeView extends View {
	private OnBladeViewItemClickListener mOnItemClickListener;
	...
	private void showPopup(int item) {
		if (mPopupWindow == null) {
			...
			mPopupWindow = new PopupWindow(mPopupText, (int) (80*scale), (int) (80*scale),true);
		}
	...
	public void setOnBladeViewItemClickListener(OnBladeViewItemClickListener listener) {
	...
	public interface OnBladeViewItemClickListener {
