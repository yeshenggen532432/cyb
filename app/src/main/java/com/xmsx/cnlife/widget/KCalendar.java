...
public class KCalendar extends ViewFlipper implements android.view.GestureDetector.OnGestureListener {
	public static final int COLOR_BG_WEEK_TITLE = Color.parseColor("#ffffffff"); // 星期标题背景颜色(白色)
	public static final int COLOR_TX_WEEK_TITLE = Color.parseColor("#ff333333"); // 星期标题文字颜色(灰3)
	public static final int COLOR_TX_THIS_MONTH_DAY = Color.parseColor("#dd333333"); // 当前月日历数字颜色
	public static final int COLOR_TX_OTHER_MONTH_DAY = Color.parseColor("#ffcccccc"); // 其他月日历数字颜色
	public static final int COLOR_TX_THIS_DAY = Color.parseColor("#ff0082CE"); // 当天日历数字颜色:blue
	public static final int COLOR_BG_THIS_DAY = Color.parseColor("#ffffffff"); // 当天日历背景颜色:白
	public static final int COLOR_BG_CALENDAR = Color.parseColor("#ffffffff"); // 日历背景色：白
...
//							view.setBackgroundColor(Color.TRANSPARENT);
							view.setBackgroundResource(R.drawable.shape_oval_blue_no);
						} else {
