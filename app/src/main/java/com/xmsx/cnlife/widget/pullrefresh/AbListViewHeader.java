 ...
 */
package com.xmsx.cnlife.widget.pullrefresh;
...
public class AbListViewHeader extends LinearLayout {
	...
	private void initView(Context context) {
		...
		MyDisplayUtil.setPadding(headerView, 0, 10, 0, 10);
		...
		layoutParamsWW.width = MyDisplayUtil.scaleValue(mContext, 25);
		layoutParamsWW.height = MyDisplayUtil.scaleValue(mContext, 25);
		...
		MyDisplayUtil.setPadding(headTextLayout,0, 0, 0, 0);
		...
		MyDisplayUtil.setTextSize(tipsTextview,14);
		MyDisplayUtil.setTextSize(headerTimeView,14);
		...
		layoutParamsWW3.rightMargin = MyDisplayUtil.scaleValue(mContext, 10);
		...
		//获取View的高度
		MyDisplayUtil.measureView(this);
