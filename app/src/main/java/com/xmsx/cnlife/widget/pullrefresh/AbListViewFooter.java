...
public class AbListViewFooter extends LinearLayout {
	...
	private void initView(Context context) {
		...
		footerView.setMinimumHeight(MyDisplayUtil.scaleValue(mContext, 60));
		footerTextView = new TextView(context);
		footerTextView.setGravity(Gravity.CENTER_VERTICAL);
		setTextColor(Color.rgb(107, 107, 107));
		MyDisplayUtil.setTextSize(footerTextView,14);
		
		MyDisplayUtil.setPadding(footerView, 0, 10, 0, 10);
		...
		layoutParamsWW.rightMargin = MyDisplayUtil.scaleValue(mContext, 10);
