...
//    private final static String[] battery1 = new String[]{"com.coloros.oppoguardelf", "com.coloros.powermanager.fuelgaue.PowerAppsBgSetting"};
    ...
    private final static String[] battery2 = new String[]{"com.color.safecenter", "com.color.powermanager.settings.PowerMgrSettingsActivity"};
    private final static String[] battery3 = new String[]{"com.oppo.purebackground", "com.oppo.purebackground.PurebackgroundTopActivity"};
    ...
    private final static String[] AutoStar2 = new String[]{"com.color.safecenter", "com.color.safecenter.permission.startup.StartupAppListActivity"};
    private final static String[] AutoStar3 = new String[]{"com.oppo.safe", "com.color.safecenter.permission.startup.StartupAppListActivity"};
